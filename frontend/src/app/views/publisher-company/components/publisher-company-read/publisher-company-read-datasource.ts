...
export class PublisherCompanyReadDataSource extends DataSource<PublisherCompany> {
   ...
   */
  connect(): Observable<PublisherCompany[]> {
   ...
   */
  private getPagedData(data: PublisherCompany[]): PublisherCompany[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: PublisherCompany[]): PublisherCompany[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'id': return compare(a.id ? a.id : '', b.id ? b.id : '', isAsc);
        default: return 0;
      }
    });
  }
